        ...
        <div className="mx-auto max-w-6xl px-4 py-5">
          ...
          <div className="flex flex-wrap items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-3">
              ...
              {/* Google Maps */}
              <a
                href="https://www.google.com/maps/search/?api=1&query=India+Recycles+Godown+3+SK+Estate+Nr+Nagdev+mandir+Sarkhej+Gandhinagar+Highway+LJ+University+Rd+Ahmedabad"
                target="_blank"
                rel="noopener noreferrer"
          ...
          >
            ...
            <span>
              ...
              {", "}Godown no. 3 SK Estate, Nr Nagdev mandir, Sarkhej - Gandhinagar Highway, LJ University Rd, Ahmedabad
            </span>
          </a>
        </div>
      </footer>
