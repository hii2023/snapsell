        ...
        <div className="mx-auto flex max-w-6xl flex-wrap items-center justify-between gap-3 px-4 py-3">
          ...
          <div className="flex items-center gap-2">
            <a
              ...
              className="flex h-8 w-8 items-center justify-center rounded-full bg-gradient-to-tr from-amber-500 via-pink-500 to-purple-600 text-white transition-transform hover:scale-105 active:scale-95"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-xs font-semibold text-neutral-600 hover:text-emerald-700 sm:text-sm"
            >
              indiarecycles.org
            </a>
          </div>
